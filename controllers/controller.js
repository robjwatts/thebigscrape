  ...
  request('http://www.gizmodo.com/', function(error, response, html) {
    ...
    $('h1.headline').each(function(i, element) {
       ...
       result.title = $(this).children("a").text().trim();
        ...
        result.summary = "we're trying to get a summary feature for you. we're very low energy. just the worst, folks. sad!" //convert to string for error handling later
